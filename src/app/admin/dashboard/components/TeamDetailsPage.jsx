...
const TeamDetailsPage = ({ team, onBack, onStatusChange, onDeleteTeam }) => {
  ...
  return (
    <div className="container mx-auto px-4 py-6 bg-gradient-to-br from-indigo-50 to-white min-h-screen">
      <Toaster position="top-right" />
      <div className="bg-white shadow-2xl rounded-2xl overflow-hidden">
        {/* Header Section */}
        <div className="p-4 md:p-6 bg-gradient-to-r from-indigo-600 to-purple-600 text-white flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-6">
          <Button
            variant="ghost"
            size="icon"
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-2xl md:text-4xl font-bold ml-3 mr-6">
                {team.teamName}
              </h1>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 md:p-6">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 p-4 md:p-6 rounded-xl">
              <h2 className="text-lg md:text-xl font-semibold text-indigo-800 border-b-2 border-indigo-200 pb-2 mb-4">
                Team Information
              </h2>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 ml-2">
                      ...
                      <Button
                        variant="ghost"
                        size="icon"
                        onClick={() => handleDownload(pdfUrl, label)}
                        disabled={!submitted}
                        className="hover:bg-indigo-50"
                      >
                        <Download className="h-5 w-5 text-indigo-500 hover:text-indigo-700" />
                      </Button>
                    </div>
                  </div>
                ))}
                ...
                <DialogContent className="sm:max-w-[425px] bg-white text-black">
                  ...
                  <DialogFooter>
                    <Button
                      ...
                      className="bg-blue-600 text-white disabled:bg-blue-300 hover:bg-blue-700 active:bg-blue-800 transition duration-200 ease-in-out"
